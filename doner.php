...
echo "<script>alert('Your details added Scuccessfully');</script>";
}
else
{
...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            <h5 class="text-center mb-4">Doner details</h5>
...
<?php }} ?>
                                ...
                                <button type="submit" class="btn btn-primary submit mb-4" name="submit"href="login.php">Add Doner</button>
                              
                                 <p class="account-w3ls text-center pb-4" style="color:#000">
                                   Already Registered as Doner?
                                    <a href="login.php" >Add Doner</a>
                                </p>
                            </form>
                        </div>
